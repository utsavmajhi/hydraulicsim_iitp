            ...
            child: Column(
              ...
              children: [
                ...
                RoundedButtonSmall(title:"Simulate",colour: Colors.deepPurple,onPressed: (){
                  ...
                  double flowrate=(rpm*dispvol*pow(10, -6)*2*3.14)/60; //m^3/s
                  double pressureout=Powerating/(flowrate); //Pascal
                  double areapiston=(3.14*Boredia*Boredia)/40000; //m^2
                  double forceonpiston=(pressureout*areapiston)/1000; //KN
                  double velopiston=flowrate/areapiston;
                  double velocity_fluid=(flowrate*4)/(3.14*pow(pipe_dia,2)*pow(10,-4));

                  // double reynold_num=((fluid_density*velocity_fluid*pipe_length)/fluid_viscosity);
                  double reynold_num=(fluid_density*velocity_fluid*pipe_dia*pow(10,-2))/fluid_viscosity;

                  double friction_factor=64/reynold_num;
                  double area_rod=3.14*piston_rod_dia*piston_rod_dia/40000;
                  double headloss=(friction_factor*pipe_length*pow(velocity_fluid,2))/(2*9.81*pipe_dia*pow(10,-2));
                  double pressure_diff=((pressureout-headloss)*areapiston)-((areapiston-area_rod)*pow(10,5));//P1A1 - P2A2  ====> P2 = 1atm = 10^5 pascal
